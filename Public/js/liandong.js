...
$(function () {
    //SKU信息
    $(".div_contentlist").on("change", "label", function () {
        step.Creat_Table();
    });
    var step = {
        //SKU信息组合
        Creat_Table: function () {
            ...
            $.each(SKUObj, function (i, item) {
                ...
                columnIndex++;
                arrayTile.push(SKUObj.find("li").find("span").eq(i).html().replace("：", ""));
            ...
            if (bCheck == true) {
                ...
                var itemColumHead = $("<th style=\"width:10%;\">价格</th><th style=\"width:10%;\">库存</th> ");
                itemColumHead.appendTo(trHead);
                var itemColumHead2 = $("<th style=\"width:10%;\">活动价</th><th style=\"width:10%;\">原价</th>");
                itemColumHead2.appendTo(trHead);
                var itemColumHead3 = $("<th style=\"width:20%;\">APP图上传</th><th style=\"width:20%;\">PC图上传</th>");
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        td4.appendTo(tr);
                        var td5 = $("<td ><form  enctype=\"multipart/form-data\" method=\"post\" id=\"img1\">" +
                            ...
                            "<img src=\"/public/img/addimg.png\"   width=\"50px;\" height=\"50px;\" style=\"float: left;\">" +
                            "<input class=\"upload-input\" type=\"file\" size=\"100\" name=\"upload_file\" id=\"uploadFile\" onchange=\"uploadImages(this);\">" +
                            "</div></div></form><div class=\"imgadd appimg\" > </div> </td>");
                        td5.appendTo(tr);
                        var td6 = $("<td ><form  enctype=\"multipart/form-data\" method=\"post\" id=\"img1\">" +
                            "<div class=\"imgCon \" colspan=\"5\" style=\"position: relative;height: 50px;width: 50px;\">" +
                            "<div class=\"uopImg upBtn upload-btn-a\" data-type=\"avatar\" data-is_edit=\"1\" data-inited=\"1\" >" +
                            "<img src=\"/public/img/addimg.png\"   width=\"50px;\" height=\"50px;\" style=\"float: left;\">" +
                            "<input class=\"upload-input\" type=\"file\" size=\"100\" name=\"upload_file\" id=\"uploadFile\" onchange=\"uploadImages(this);\">" +
                            "</div></div></form><div class=\"imgadd pcimg\" > </div> </td>");
                        td6.appendTo(tr);
                    });
                }
                //结束创建Table表
