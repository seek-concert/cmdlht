...
function dTree(objName) {
	...
	this.icon = {
		root				: '/Public/app/img/base.gif',
		folder			: '/Public/app/img/folder.gif',
		folderOpen	: '/Public/app/img/folderopen.gif',
		node				: '/Public/app/img/page.gif',
		empty				: '/Public/app/img/empty.gif',
		line				: '/Public/app/img/line.gif',
		join				: '/Public/app/img/join.gif',
		joinBottom	: '/Public/app/img/joinbottom.gif',
		plus				: '/Public/app/img/plus.gif',
		plusBottom	: '/Public/app/img/plusbottom.gif',
		minus				: '/Public/app/img/minus.gif',
		minusBottom	: '/Public/app/img/minusbottom.gif',
		nlPlus			: '/Public/app/img/nolines_plus.gif',
		nlMinus			: '/Public/app/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
