...
<html>
	...
	<div class="con">
		<form action="/Index/index" method="post" id="ajax-form">
			<div class="input">
				<div class="item">
					账户
				...
				<div class="item">
					...
					<img width="30%" class="left15" height="50" alt="验证码" src="<?php echo U('code',array());?>" onclick='this.src=this.src+"?c="+Math.random()' title="点击刷新"/>
	...
	<div class="foot">
		...
		<script type="text/javascript" src="/Public/js/jquery2-1-4.min.js"></script>
